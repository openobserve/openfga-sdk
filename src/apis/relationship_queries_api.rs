...
pub async fn streamed_list_objects(configuration: &configuration::Configuration, store_id: &str, body: crate::models::ListObjectsRequest) -> Result<crate::models::StreamResultOfStreamedListObjectsResponse, Error<StreamedListObjectsError>> {
    let local_var_configuration = configuration;
