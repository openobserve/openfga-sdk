...
pub async fn create_store(
...
) -> Result<crate::models::CreateStoreResponse, Error<CreateStoreError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateStoreError> =
...
pub async fn delete_store(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteStoreError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_store(
    configuration: &configuration::Configuration,
    store_id: &str,
) -> Result<crate::models::GetStoreResponse, Error<GetStoreError>> {
    let local_var_configuration = configuration;
...
pub async fn list_stores(
...
) -> Result<crate::models::ListStoresResponse, Error<ListStoresError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListStoresError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
