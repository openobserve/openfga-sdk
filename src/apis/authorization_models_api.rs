...
pub async fn read_authorization_model(
    ...
    store_id: &str,
    id: &str,
) -> Result<crate::models::ReadAuthorizationModelResponse, Error<ReadAuthorizationModelError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadAuthorizationModelError> =
...
pub async fn read_authorization_models(
...
) -> Result<crate::models::ReadAuthorizationModelsResponse, Error<ReadAuthorizationModelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadAuthorizationModelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn write_authorization_model(
...
) -> Result<crate::models::WriteAuthorizationModelResponse, Error<WriteAuthorizationModelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<WriteAuthorizationModelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
